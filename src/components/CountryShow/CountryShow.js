...
class CountryShow extends React.Component {
  renderBorderLinks = () => {
    return this.props.borderCountries.map(country => {
      return <CountryLink country={country} key={country.numericCode} />;
    });
  };
              ...
              <div className="column">
                ...
                <div className="ui two column grid">
                  <div className="row">
                    <div className="column">
                      <p>
                        <b>Native Name:</b> {this.props.country.nativeName}
                      </p>
                      <p>
                        <b>Population:</b>{' '}
                        {this.numberWithCommas(this.props.country.population)}
                      </p>
                      <p>
                        <b>Region:</b> {this.props.country.region}
                      </p>
                      <p>
                        <b>Sub Region:</b> {this.props.country.subregion}
                      </p>
                      <p>
                    ...
                    <div className="column">
                      ...
                      <p>
                        <b>Currencies:</b>{' '}
                        {this.joinCurrencies(this.props.country.currencies)}
                      </p>
                      <p>
                        <b>Languages:</b>{' '}
                        {this.joinLanguages(this.props.country.languages)}
                      </p>
                    </div>
                  </div>
                  <div className="row">
...
export default connect(
  mapStateToProps,
  { fetchCountriesByCode, selectCountry }
)(CountryShow);
